...
<?php
	...
	if($prev)
	{
		...
		echo '<a href="http://beta.tsiserver.us/'.$pageUrl.'pg='.$prevPage.'" style="text-decoration: none;" class="button small" name="prev" >Previous Page</a>';
	}
	
	if($ct >=19)
	{
		echo '<a href="http://beta.tsiserver.us/'.$pageUrl.'pg='.$next.'" style="text-decoration: none;" class="button small" name="next">Next Page</a>';
	}
	?>
	</center>